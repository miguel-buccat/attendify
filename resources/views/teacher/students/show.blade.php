        ...
        <main class="flex-1 min-w-0 lg:min-h-screen pt-14 lg:pt-0">
            <div class="p-4 md:p-6 lg:p-8 space-y-5">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                        <div class="flex items-center gap-4">
                            @if ($student->avatarUrl)
                                <img src="{{ $student->avatarUrl }}" class="size-16 rounded-2xl object-cover ring-2 ring-base-300/50" alt="">
                            @else
                                <div class="size-16 rounded-2xl bg-accent/10 flex items-center justify-center text-2xl font-black text-accent">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div class="bg-base-100 border border-base-300/50 rounded-2xl p-4 text-center">
                            ...
                            <tbody>
                                @forelse ($records as $record)
                                    <tr class="border-b border-base-200/50">
                                        ...
                                        <td><span class="badge badge-sm badge-ghost rounded-lg">{{ $record->classSession->modality->value }}</span></td>
                                        <td>
                                            @php
                                            ...
                                            @endphp
                                            <span class="badge badge-sm {{ $statusColor }} rounded-lg">{{ $record->status->value }}</span>
                                        </td>
